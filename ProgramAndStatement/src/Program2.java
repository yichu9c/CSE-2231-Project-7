...
public class Program2 extends ProgramSecondary {
    ...
    private void createNewRep() {
        ...
        /*
         * Creates the new empty representation based on the slides in class.
         */
        this.name = "Unnamed";
    ...
    public Program2() {
        /*
         * Creates new representation by calling .createNewRep()
         */
        this.createNewRep();
    }
    ...
    public final void setName(String n) {
        ...
        /*
         * Sets the name of this to the string parameter.
         */
        this.name = n;
    ...
    public final Map<String, Statement> newContext() {
        ...
        /*
         * Returns an empty context with the same dynamic type as this.
         */
    ...
    public final void swapContext(Map<String, Statement> c) {
        ...
        /*
         * Creates an empty temp variable with the same dynamic type as this.
         * Then uses .transferFrom to swap the context of this and parameter c.
         */
    ...
    public final Statement newBody() {
        ...
        /*
         * Returns an empty body with the same dynamic type as this.
         */
    ...
    public final void swapBody(Statement b) {
        ...
        /*
         * Creates an empty temp variable with the same dynamic type as this.
         * Then uses .transferFrom to swap the body of this and parameter b.
         */
